...
ALPHA = 0.1            # Learning rate (α) # Update frequency
...
# --- ADDED CODE TO SAVE MODEL WEIGHTS AFTER TRAINING ---
# Define the file path where the model weights will be saved
MODEL_SAVE_PATH = 'dqn_traffic_model_weights.h5'

try:
    # Save the weights of the neural network
    dqn_model.save_weights(MODEL_SAVE_PATH)
    print(f"\nSuccessfully saved model weights to: {MODEL_SAVE_PATH}")
